...
from app.domain.admin.admin_permissions import ManageRolesPermission, EnterAdminPanelPermission
from app.domain.admin.forms import BindRolesWithUserForm, CreateRolesForm
...
def bind_roles_with_user():
    ...
    return render_template('admin/bind_roles_with_user.html', form=form)
